...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function handlePostCreation(caption, imageFile) {
        const newPost = {
            id: postsData.length + 1, // Generating new ID
            author: 'You', // Assuming the current user is creating the post
            content: caption,
            likes: 0,
            comments: [],
    ...
    document.getElementById("postForm").addEventListener("submit", function(event) {
        ...
        const imageFile = document.getElementById("imageInput").files[0]; // Assuming you want to get the first selected file
        
        // Check if imageFile is present
        if (imageFile) {
            handlePostCreation(caption, imageFile);
